...
/***/ (function(module, exports, __webpack_require__) {
	...
	const SkillsBarChart = __webpack_require__(33);
	...
	window.updateChart = function () {
	  ...
	  const data = origData.map(function (category) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var d3Array = __webpack_require__(3);
	var d3Axis = __webpack_require__(4);
	var d3Brush = __webpack_require__(5);
	var d3Chord = __webpack_require__(14);
	var d3Collection = __webpack_require__(16);
	var d3Color = __webpack_require__(10);
	var d3Dispatch = __webpack_require__(6);
	var d3Drag = __webpack_require__(7);
	var d3Dsv = __webpack_require__(17);
	var d3Ease = __webpack_require__(13);
	var d3Force = __webpack_require__(18);
	var d3Format = __webpack_require__(20);
	var d3Geo = __webpack_require__(21);
	var d3Hierarchy = __webpack_require__(22);
	var d3Interpolate = __webpack_require__(9);
	var d3Path = __webpack_require__(15);
	var d3Polygon = __webpack_require__(23);
	var d3Quadtree = __webpack_require__(19);
	var d3Queue = __webpack_require__(24);
	var d3Random = __webpack_require__(25);
	var d3Request = __webpack_require__(26);
	...
	var d3Transition = __webpack_require__(11);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? factory(exports, __webpack_require__(6), __webpack_require__(7), __webpack_require__(9), __webpack_require__(8), __webpack_require__(11)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? factory(exports, __webpack_require__(6), __webpack_require__(8)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? factory(exports, __webpack_require__(8), __webpack_require__(6), __webpack_require__(12), __webpack_require__(9), __webpack_require__(10), __webpack_require__(13)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? factory(exports, __webpack_require__(19), __webpack_require__(16), __webpack_require__(6), __webpack_require__(12)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? factory(exports, __webpack_require__(3), __webpack_require__(16), __webpack_require__(9), __webpack_require__(20), __webpack_require__(28), __webpack_require__(29), __webpack_require__(10)) :
	...
	;(function (root, factory) {
	    ...
	    var SkillsBarChart = function () {
	        function SkillsBarChart(options) {
	            ...
	            this._guideData = [{ label: 'Novice', value: 0, anchor: 'start' }, { label: 'Proficient', value: 33, anchor: 'middle' }, { label: 'Advanced', value: 66, anchor: 'middle' }, { label: 'Expert', value: 100, anchor: 'end' }];
	            if (options.data) {
	        ...
	        SkillsBarChart.prototype.target = function (el) {
	            ...
	            var svg = this._svg = this._el.append('svg').style('display', 'block');
	            var inner = this._inner = svg.append('g').classed('skills-barchart-inner', true).attr('transform', "translate(" + this._margin.left + ", " + this._margin.top + ")");
	            this._guidesGrp = inner.append('g').classed('skills-barchart-guides', true);
	            return this;
	        };
	        SkillsBarChart.prototype.render = function () {
	            ...
	            var svg = this._svg;
	            var ctx = this._inner;
	            svg.transition().duration(this._animDuration).attr('height', height + this._margin.top + this._margin.bottom).attr('width', width);
	            this._guidesGrp.attr('transform', "translate(0, -10)");
	            var guide = this._guidesGrp.selectAll('g.skill-level-guide').data(this._guideData, function (g) {
	                return g.label;
	            });
	            guide.exit().remove();
	            var newGuide = guide.enter().append('g').classed('skill-level-guide', true).attr('transform', function (g) {
	                return "translate(" + scale(g.value) + ", 0)";
	            });
	            newGuide.append('text').classed('skill-level-guide-label', true).attr('text-anchor', function (g) {
	                return g.anchor;
	            }).attr('fill', '#CCC').attr('dy', '-0.4em').text(function (g) {
	                return g.label;
	            });
	            newGuide.append('line').classed('skill-level-guide-line', true).attr('stroke', '#CCC').attr('x1', 0).attr('y1', 0).attr('x2', 0).attr('y2', 0);
	            guide = newGuide.merge(guide);
	            guide.select('line.skill-level-guide-line').transition().duration(this._animDuration).attr('y2', height);
	            var category = ctx.selectAll('g.skill-category').data(this._data, function (d) {
	                return d.name;
	            });
	            category.exit().transition().duration(this._animDuration).style('opacity', 0).remove();
	            var newCategory = category.enter().append('g').classed('skill-category', true).attr('transform', function (c) {
	                return "translate(0," + c.yOffset + ")";
	            });
	            newCategory.append('rect').classed('skill-category-title-bg', true).attr('fill', '#DEDEDE').attr('x', innerWidth + 3).attr('y', 0).attr('width', this._lineHeight - 3).attr('height', function (c) {
	                return c.height - 5;
	            });
	            newCategory.append('text').classed('skill-category-title', true).style('font-size', '120%').attr('dx', '0.4em').attr('dy', '-0.6em').text(function (c) {
	                return c.name;
	            }).attr('transform', function (c) {
	                return "translate(" + innerWidth + ", 0) rotate(90)";
	            });
	            category = newCategory.merge(category);
	            category.transition().duration(this._animDuration).attr('transform', function (c) {
	                return "translate(0, " + c.yOffset + ")";
	            });
	            category.select('rect.skill-category-title-bg').attr('x', innerWidth + 3).attr('height', function (c) {
	                return c.height - 5;
	            });
	            var skill = category.selectAll('g.skill-group').data(function (c) {
	                return c.entries;
	            }, function (e) {
	                return e.name;
	            });
	            var newSkill = skill.enter().append('g').classed('skill-group', true).attr('transform', function (d, i) {
	                return "translate(0, " + i * _this._lineHeight + ")";
	            });
	            skill.exit().transition().duration(this._animDuration).style('opacity', 0).remove();
	            newSkill.append('rect').classed('skill-level', true).attr('width', 0).attr('height', 25).style('opacity', 0.8).attr('fill', function () {
	                var cat = d3.select(this.parentNode.parentNode).datum();
	                return cat.color;
	            });
	            newSkill.append('text').classed('skill-name', true).text(function (s) {
	                return s.name;
	            }).attr('transform', 'translate(5,0)').attr('font-size', 16).attr('fill', 'white').attr('dy', '1em');
	            skill = newSkill.merge(skill);
	            skill.transition().duration(this._animDuration).attr('transform', function (d, i) {
	                return "translate(0, " + i * _this._lineHeight + ")";
	            });
	            skill.select('rect.skill-level').transition().duration(this._animDuration).attr('width', function (s) {
